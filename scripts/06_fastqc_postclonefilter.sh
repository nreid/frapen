...
INDIR=../results/clone_filtered_fastqs/

OUTDIR=../results/fastqc_post_clonefilter
mkdir -p $OUTDIR
...
# get R1 and R2 file names for this array instance
    # clone_filter is doing something stupid with the names and I don't know why
FQ1=${FQ[$SLURM_ARRAY_TASK_ID]}
FQ2=$(echo $FQ1 | sed 's/1.1.fq.gz/2.2.fq.gz/')
